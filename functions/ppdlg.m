function Answer = ppdlg(prompt,title,position)
...
file_name = uicontrol('style','edit','Units','normalized','Position',...
     [.05,.5,.9,.2],'String','save as .mat file');
