...
plot3([f2(1,4),f3(1,4)],[f2(2,4),f3(2,4)],[f2(3,4),f3(3,4)],link_color(7),'linewidth',4);
plot3([f3(1,4),f4(1,4)],[f3(2,4),f4(2,4)],[f3(3,4),f4(3,4)],link_color(5),'linewidth',4);
plot3([f4(1,4),f5(1,4)],[f4(2,4),f5(2,4)],[f4(3,4),f5(3,4)],link_color(3),'linewidth',4);
plot3([f5(1,4),fle(1,4)],[f5(2,4),fle(2,4)],[f5(3,4),fle(3,4)],link_color(1),'linewidth',4);
...
plot3([f7(1,4),f8(1,4)],[f7(2,4),f8(2,4)],[f7(3,4),f8(3,4)],link_color(8),'linewidth',4);
plot3([f8(1,4),f9(1,4)],[f8(2,4),f9(2,4)],[f8(3,4),f9(3,4)],link_color(6),'linewidth',4);
plot3([f9(1,4),f10(1,4)],[f9(2,4),f10(2,4)],[f9(3,4),f10(3,4)],link_color(4),'linewidth',4);
plot3([f10(1,4),fre(1,4)],[f10(2,4),fre(2,4)],[f10(3,4),fre(3,4)],link_color(2),'linewidth',4);

%com to chest plot
plot3([f00(1,4),f01(1,4)],[f00(2,4),f01(2,4)],[f00(3,4),f01(3,4)],link_color(17),'linewidth',4);

plot3([f01(1,4),0],[f01(2,4),0],[f01(3,4),400],link_color(18),'linewidth',4);


%left hand plot
plot3([f01(1,4),f11(1,4)],[f01(2,4),f11(2,4)],[f01(3,4),f11(3,4)],link_color(17),'linewidth',4);
plot3([f11(1,4),f12(1,4)],[f11(2,4),f12(2,4)],[f11(3,4),f12(3,4)],c,'linewidth',4);
plot3([f12(1,4),f13(1,4)],[f12(2,4),f13(2,4)],[f12(3,4),f13(3,4)],link_color(13),'linewidth',4);
plot3([f13(1,4),f14(1,4)],[f13(2,4),f14(2,4)],[f13(3,4),f14(3,4)],link_color(15),'linewidth',4);

%right hand plot
plot3([f01(1,4),f15(1,4)],[f01(2,4),f15(2,4)],[f01(3,4),f15(3,4)],link_color(17),'linewidth',4);
plot3([f15(1,4),f16(1,4)],[f15(2,4),f16(2,4)],[f15(3,4),f16(3,4)],c,'linewidth',4);
plot3([f16(1,4),f17(1,4)],[f16(2,4),f17(2,4)],[f16(3,4),f17(3,4)],link_color(14),'linewidth',4);
plot3([f17(1,4),f18(1,4)],[f17(2,4),f18(2,4)],[f17(3,4),f18(3,4)],link_color(16),'linewidth',4);

%neck plot/head
plot3([f01(1,4),f19(1,4)],[f01(2,4),f19(2,4)],[f01(3,4),f19(3,4)],'k','linewidth',4);
plot3([f19(1,4),f20(1,4)],[f19(2,4),f20(2,4)],[f19(3,4),f20(3,4)],'k','linewidth',4);
...
%foot plots
plot3([footl(1,4),fl1(1,4)],[footl(2,4),fl1(2,4)],[footl(3,4),fl1(3,4)],link_color(1),'linewidth',4); 
plot3([fl1(1,4),fl2(1,4)],[fl1(2,4),fl2(2,4)],[fl1(3,4),fl2(3,4)],link_color(1),'linewidth',4);
plot3([fl2(1,4),fl3(1,4)],[fl2(2,4),fl3(2,4)],[fl2(3,4),fl3(3,4)],link_color(1),'linewidth',4);
plot3([fl3(1,4),fl4(1,4)],[fl3(2,4),fl4(2,4)],[fl3(3,4),fl4(3,4)],link_color(1),'linewidth',4);
plot3([footr(1,4),fr1(1,4)],[footr(2,4),fr1(2,4)],[footr(3,4),fr1(3,4)],link_color(2),'linewidth',4); 
plot3([fr1(1,4),fr2(1,4)],[fr1(2,4),fr2(2,4)],[fr1(3,4),fr2(3,4)],link_color(2),'linewidth',4);
plot3([fr2(1,4),fr3(1,4)],[fr2(2,4),fr3(2,4)],[fr2(3,4),fr3(3,4)],link_color(2),'linewidth',4);
plot3([fr3(1,4),fr4(1,4)],[fr3(2,4),fr4(2,4)],[fr3(3,4),fr4(3,4)],link_color(2),'linewidth',4);
